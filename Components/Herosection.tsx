    ...
    <div className='h-auto w-screen bg-[#0085FF]'>
      ...
      <div className='grid  md:grid-flow-col items-center justify-center scroll-smooth md:ml-8'>
        <div className=' max-w-[750px] md:p-12 md:mt-8 mt-2'>
          ...
          <Link href='#Services'>
          <button className='bg-[#FF9900] font-extrabold p-3 md:px-10 px-8  md:mt-3 rounded-md text-white md:py-5 '>CONTACT US</button>
          </Link>
          </div>
        </div>
        <div className=' '>
        ...
        height={800}
        alt="homepage"
        className='md:-ml-[100px] md:mt-[40px]'
        />
        </div>
      </div>
      <div className='flex items-center justify-center bg-[#0085FF] -mt-2 px-3 '>
