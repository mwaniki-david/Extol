...
const Services = () => {
  ...
  return (
    <div  id='Services' className='flex bg-white h-auto md:h-screen mt-[220px] md:mt-[300px] items-center justify-center p-2 '>
      <div className='p-2 px-12'>
        ...
        <div className=' bg-[#59AFFF] rounded-3xl p-2 gap-10 text-bold'>
          <h1 className='text-2xl uppercase p-2 text-bold'>Content Writing</h1>
        ...
        <div className=' bg-black rounded-3xl p-2 gap-10 text-bold'>
          <h1 className='text-2xl uppercase p-2 text-bold'>Video Editing</h1>
        ...
        <div className=' bg-black rounded-3xl p-2 gap-10 text-bold'>
          <h1 className='text-2xl uppercase p-2 text-bold'>Software Development</h1>
        ...
        <div className=' bg-[#59AFFF] rounded-3xl p-2 gap-10 text-bold'>
          <h1 className='text-2xl uppercase p-2 text-bold'>Transcription Services</h1>
        ...
        <div className=' bg-[#FF9900] rounded-3xl p-2 gap-10 text-bold'>
          <h1 className='text-2xl uppercase p-2 text-bold'>Digital Marketing</h1>
